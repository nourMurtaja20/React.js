...
let NewTaskPage = () => {
    ...
    let save = () => {
        ...
        let task = new Task(Date.now(), nameRef.current.value, category.id, category.name, detailsRef.current.value, startDateRef.current.value, endDateRef.current.value);
