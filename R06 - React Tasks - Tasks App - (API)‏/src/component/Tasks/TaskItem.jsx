    ...
    return <div className="col-md-4">
        <div className="card task card">
            ...
            <div className="card-body">
                ...
                <h6 className="card-subtitle mb-2 text-muted">    <span data-feather="calendar"></span> {props.task.from_date} <span className="main-color">To </span> {props.task.to_date}</h6>
