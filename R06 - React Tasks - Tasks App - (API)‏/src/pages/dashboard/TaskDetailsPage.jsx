        ...
        <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div className="row mt-5">
                <div className="col-md-6">
                    <img src={task.image_url} className="img-fluid rounded de-img" />
                </div>
                <div className="col-md-6  mt-5">
                    ...
                    <div className="mb-3">
                        <span data-feather="layers" className="main-color"></span> <strong>Category:</strong> {task.category_name}
                    </div>
                    <div className="">
                        <span data-feather="calendar" className="main-color"></span> <strong>Date:</strong> {task.from_date} to {task.to_date}
                    </div>
                </div>
                <div className="row mt-5">
